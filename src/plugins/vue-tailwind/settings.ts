...
export const settings = {
    ...
    't-button': {
        ...
        props: {
            ...
            classes: 'text-white bg-primary-500 border border-transparent shadow-sm rounded hover:bg-blue-600',
            variants: {
                primary: 'text-white bg-primary-500 border border-transparent shadow-sm rounded hover:bg-primary-600',
    ...
    't-rich-select': {
        ...
        props: {
            ...
            classes: {
                ...
                option: '',
                disabledOption: '',
                highlightedOption: 'bg-pink-400 hover:text-white',
                selectedOption: 'font-medium bg-primary-500 text-white',
                selectedHighlightedOption: 'font-medium bg-primary-500 text-white',
    ...
    't-dialog': {
        ...
        props: {
            ...
            classes: {
                ...
                okButton: 'bg-primary-500 hover:bg-blue-600',
        ...
        props: {
            ...
            variants: {
                rounded: {
                    ...
                    activeButton: 'border border-blue-500 bg-primary-500 w-full h-full rounded-full text-white hover:bg-blue-600 transition duration-100 ease-in-out focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
    ...
    't-dropdown': {
        ...
        props: {
            ...
            classes: {
                button: 'bg-primary-500 hover:bg-blue-600',
                dropdown: 'bg-white'
            },
            variants: {
                danger: {
